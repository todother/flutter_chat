...
// bool function isSystemEvent(event) {
//     switch (event) {
...
//         if (wait[0] == waitIsConfirmationPrefix) {
//             return true;
//         }

//         return wait[0] == waitComesFromClientPrefix || false;
//     };
...
// var escapeRegExp =  RegExp(messageSeparator);
// escapeMessageField(s) {
//     if (isEmpty(s)) {
//         return "";
//     }
...
// var unescapeRegExp =  RegExp(messageFieldSeparatorReplacement);
//  unescapeMessageField(s){
//     if (isEmpty(s)) {
//         return "";
//     }
...
// var textEncoder = base64.encoder;
// var textDecoder = base64.decoder;
// var messageSeparatorCharCode = messageSeparator.charCodeAt(0);

// String serializeMessage( msg) {
...
//         // so:
//         var b = textEncoder.convert(data);
...
// splitN(String s,String sep,int limit)  {
//     if (limit == 0) return [s];
//     var arr = s.split(sep);
//     if (arr.length == limit) {
//         var curr = arr.join(sep) + sep;
//         arr.push(s.substring(curr.length));
//         return arr;
//     } else {
//         return [s];
//     }
...
// // <isNoOp(0-1)>;
// // <body||error_message>
//  deserializeMessage(data, bool allowNativeMessages)  {
//     var msg = new Message();
//     if (data.length == 0) {
//         msg.isInvalid = true;
//         return msg;
...
//     var isArrayBuffer = data.runtimeType== Uint8List;
//     var dts;

//     if (isArrayBuffer) {
//         const arr = new Uint8List(data);
//         let sepCount = 1;
//         let lastSepIndex = 0;
...
//         dts = splitN(textDecoder.decode(arr.getRange(0, lastSepIndex)), messageSeparator, validMessageSepCount - 2);
...
// String genWaitConfirmation(wait: string) {
//     return waitIsConfirmationPrefix + wait;
// }

// String genEmptyReplyToWait(wait: string) {
...
//     constructor(NSConn ns ,String roomName) {
//         this.nsConn = ns;
//         this.name = roomName;
//     }
...
//     NSConn(Conn conn ,String namespace,Map<String, (NSConn c ,Message msg ) => > events ) {
//         this.conn = conn;
